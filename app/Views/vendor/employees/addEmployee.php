                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <button id="addvendor" type="button" class="btn btn-primary">Add Employee</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="<?= base_url('public/assets/main/ajaxPages/vendor/addEmployee.js') ?> "></script>
