...
<html lang="en">
    ...
    <body class="auth-body-bg">
                                            ...
                                            <div class="p-2 mt-5">
                                                <form class="">
                                                    ...
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" value="1" id="loginType" name="loginType" id="customControlInline">
                                                        <label class="form-check-label" for="customControlInline">Login as Employee</label>
                                                    </div> 
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" value="0" id="loginType" name="loginType"  id="customControlInline">
                                                        <label class="form-check-label" for="customControlInline">Login as Admin</label>
                                                    </div>
        ...
        <script src="<?= base_url('public/assets/main/ajaxPages/vendor/login.js') ?> "></script>
        

        <?php $error = session('errorMsg'); if($error != '') { ?>
            <script>
                toastr.error('<?= $error ?>');
            </script>
