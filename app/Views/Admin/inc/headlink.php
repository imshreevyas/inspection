...
<!-- Bootstrap Css -->
<link href="<?= base_url('public/assets/main/css/bootstrap-dark.min.css') ?>" id="bootstrap-style" rel="stylesheet" type="text/css" />
<!-- Icons Css -->
<link href="<?= base_url('public/assets/main/css/icons.min.css') ?>" rel="stylesheet" type="text/css" />
<!-- App Css-->
<link href="<?= base_url('public/assets/main/css/app-dark.min.css') ?>" id="app-style" rel="stylesheet" type="text/css" />
<!-- Custom Css -->
